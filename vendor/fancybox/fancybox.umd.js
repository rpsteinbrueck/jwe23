!(function (t, e) {
    ...
    class I extends m {
        ...
        get isTouchDevice() {
            return (
                null === k && (k = window.matchMedia("(hover: none)").matches),
                k
            );
        }
        get isMobile() {
        ...
        constructor(t, e = {}, i = {}) {
            ...
            (this.container = t),
                this.initContent(),
                this.attachPlugins(
                    Object.assign(Object.assign({}, I.Plugins), i)
                ),
    ...
    class Lt extends _ {
        ...
        processType(t) {
            if (t.html)
                return (t.type = xt), (t.src = t.html), void (t.html = "");
            const e = this.instance.optionFor(t, "src", "");
        ...
        onInit() {
            ...
            (o.Carousel = o.Carousel || {}),
                ...
                e.option("showOnStart") ||
                    ((e.ref.state = jt.Hidden), (e.hidden = !0));
        }
        onResize() {
            var t;
            const e =
    ...
    class Te extends m {
        ...
        init() {
            ...
            const t = () => {
                this.initCarousel(this.userSlides),
                    ...
                    setTimeout(() => {
                        this.container &&
                            this.container.setAttribute(oe, "false");
                    }, 16);
            };
        ...
        isClosing() {
            return [rt.Closing, rt.CustomClosing, rt.Destroy].includes(
                this.state
            );
        }
        proceedClose(t, e) {
